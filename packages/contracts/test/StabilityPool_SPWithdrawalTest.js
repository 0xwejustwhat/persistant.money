...
contract('StabilityPool - Withdrawal of stability deposit - Reward calculations', async accounts => {
  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(alice)).toString(), '6666666666666666666666'), 10000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), '6666666666666666666666'), 10000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '6666666666666666666666'), 10000)
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(alice)).toString(), '3333333333333333333333'), 10000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), '3333333333333333333333'), 10000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '3333333333333333333333'), 10000)
    ...
    it("withdrawFromSP():  Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(alice)).toString(), '0'), 10000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), '0'), 10000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '0'), 10000)
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two liquidations of increasing ANTUSD", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveANTUSDAmount(dec(100000, 18)), whale, whale, dec(100000, 'ether'), { from: whale })
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(alice)).toString(), '6000000000000000000000'), 10000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), '6000000000000000000000'), 10000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '6000000000000000000000'), 10000)
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three liquidations of increasing ANTUSD", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveANTUSDAmount(dec(100000, 18)), whale, whale, dec(100000, 'ether'), { from: whale })
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(alice)).toString(), '4000000000000000000000'), 10000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), '4000000000000000000000'), 10000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '4000000000000000000000'), 10000)
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(alice)).toString(), '6666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), '13333333333333333333333'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '20000000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(alice)).toString(), '5000000000000000000000'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), '10000000000000000000000'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '15000000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three varying liquidations", async () => {
      ...
      */
      ...
      // ()
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(alice)).toString(), '901719380174061000000'), 100000000000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), '205592018679686000000000'), 10000000000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '5906261940140100000000'), 10000000000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 ANTUSD.  A, B, C, D withdraw correct ANTUSD deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveANTUSDAmount(dec(100000, 18)), whale, whale, dec(100000, 'ether'), { from: whale })
      ...
      console.log()
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(alice)).toString(), '1666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), '1666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '1666666666666666666666'), 100000)

      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(dennis)).toString(), '5000000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 ANTUSD.  A, B, C, D withdraw correct ANTUSD deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveANTUSDAmount(dec(100000, 18)), whale, whale, dec(100000, 'ether'), { from: whale })
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(alice)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(dennis)).toString(), '0'), 100000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct ANTUSD deposit and ETH Gain", async () => {
      // Whale opens Trove with 1m ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveANTUSDAmount(dec(1000000, 18)), whale, whale, dec(1000000, 'ether'), { from: whale })
      ...
      */
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(alice)).toString(), '17832817337461300000000'), 100000000000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), '5944272445820430000000'), 100000000000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '4458204334365320000000'), 100000000000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(dennis)).toString(), '11764705882352900000000'), 100000000000)
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. All deposits and liquidations = 100 ANTUSD.  A, B, C, D withdraw correct ANTUSD deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveANTUSDAmount(dec(100000, 18)), whale, whale, dec(100000, 'ether'), { from: whale })
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(alice)).toString(), '0'), 1000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), '0'), 1000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '0'), 1000)
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct ANTUSD deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveANTUSDAmount(dec(100000, 18)), whale, whale, dec(100000, 'ether'), { from: whale })
      ...
      */
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(alice)).toString(), '1672240802675590000000'), 10000000000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), '2090301003344480000000'), 100000000000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '1045150501672240000000'), 100000000000)
    ...
    it("withdrawFromSP(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 ANTUSD. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct ANTUSD deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveANTUSDAmount(dec(100000, 18)), whale, whale, dec(100000, 'ether'), { from: whale })
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(alice)).toString(), '666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), '666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '2000000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '5000000000000000000000'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(dennis)).toString(), '5000000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): Depositors withdraw correct compounded deposit after liquidation empties the pool", async () => {
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '8333333333333333333333'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(dennis)).toString(), '16666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(erin)).toString(), '25000000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(dennis)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(erin)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(flyn)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(graham)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(harriet)).toString(), '0'), 100000)
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      // Expect Bob to withdraw 1% of initial deposit (100 ANTUSD) and all the liquidated ETH (60 ether)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), '100000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      */
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), dec(100, 18)), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), dec(200, 18)), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(dennis)).toString(), dec(300, 18)), 100000)
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), dec(1, 17)), 100000)
    ...
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(bob)).toString(), dec(1, 17)), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(carol)).toString(), dec(2, 17)), 100000)
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(dennis)).toString(), dec(3, 17)), 100000)
    ...
    */
    it("withdrawFromSP(): Several deposits of 10000 ANTUSD span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveANTUSDAmount(dec(100000, 18)), whale, whale, dec(100000, 'ether'), { from: whale })
      ...
      assert.equal(await antusdToken.balanceOf(alice), '0')
      assert.equal(await antusdToken.balanceOf(alice), '0')
      assert.equal(await antusdToken.balanceOf(alice), '0')
      // D should withdraw around 0.9999 ANTUSD, since his deposit of 9999.9 was reduced by a factor of 1e-5
      assert.isAtMost(th.getDifference((await antusdToken.balanceOf(dennis)).toString(), dec(99999, 12)), 100000)
    ...
    it("withdrawFromSP(): Depositor's ETH gain stops increasing after two scale changes", async () => {
      ...
      // Defaulters 1-5 each withdraw up to debt of 9999.9999999 ANTUSD
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveANTUSDAmount(dec(99999, 17)), defaulter_1, defaulter_1, dec(100, 'ether'), { from: defaulter_1 })
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveANTUSDAmount(dec(99999, 17)), defaulter_2, defaulter_2, dec(100, 'ether'), { from: defaulter_2 })
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveANTUSDAmount(dec(99999, 17)), defaulter_3, defaulter_3, dec(100, 'ether'), { from: defaulter_3 })
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveANTUSDAmount(dec(99999, 17)), defaulter_4, defaulter_4, dec(100, 'ether'), { from: defaulter_4 })
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveANTUSDAmount(dec(99999, 17)), defaulter_5, defaulter_5, dec(100, 'ether'), { from: defaulter_5 })
      ...
      // E deposits 9999.9 ANTUSD
      await antusdToken.transfer(erin, dec(99999, 17), { from: whale })
    ...
    it("withdrawFromSP(): Large liquidated coll/debt, deposits and ETH price", async () => {
      ...
      const bobANTUSDBalance = await antusdToken.balanceOf(bob)
