  ...
  const testCorpus = ({ withProxy = false }) => {
    ...
    describe("getNewTCRFromTroveChange() returns the correct TCR", async () => {
      ...
      it("collChange = 0, debtChange = 0", async () => {
        ...
        await borrowerOperations.openTrove(th._100pct, troveLUSDAmount, alice, alice, troveColl, { from: alice })
        await borrowerOperations.openTrove(th._100pct, troveLUSDAmount, bob, bob, troveColl, { from: bob })
