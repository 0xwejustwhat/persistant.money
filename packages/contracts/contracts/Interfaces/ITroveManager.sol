...
interface ITroveManager is ILiquityBase {
    ...
    function getPendingANTUSDDebtReward(address _borrower) external view returns (uint);
    ...
    function getBorrowingFee(uint ANTUSDDebt) external view returns (uint);
    function getBorrowingFeeWithDecay(uint _ANTUSDDebt) external view returns (uint);
